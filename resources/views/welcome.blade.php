                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="inline-block px-5 py-1.5 bg-[#1b1b18] hover:bg-black text-white dark:bg-white dark:text-black dark:hover:bg-white/80 rounded-sm text-sm leading-normal">
                            Register
                        </a>
                    @endif
                @endauth
